...
def finalize_miniapp_purchase_history(history_id: int) -> dict:
    ...
    try:
        ...
        return {
            ...
            "operationId": build_operation_id("miniapp", history_id),
...
def build_operation_id(source: str, record_id: int) -> str:
    ...
    if safe_id <= 0:
        return f"OP-{prefix}-00000000"
    return f"OP-{prefix}-{safe_id:08d}"
...
def build_operation_payload(
    *,
    ...
    operation_id = build_operation_id(source_key, record_id)
    ...
    return miniapp_json_response(
        {
            ...
            "operation": {
                "id": build_operation_id("miniapp", history_id),
