...
def get_miniapp_purchase_history_payload(user_id: int, limit: int = 20) -> list:
    ...
    if not rows:
        ...
        for item_type, amount, cost, created_at in fallback_rows:
            ...
            rows.append((item_type, amount, price_usd, price_rub, created_at, "", "", "success"))

    payload = []
    for item_type, amount, price_usd, price_rub, created_at, promo_code, promo_error, raw_status in rows:
