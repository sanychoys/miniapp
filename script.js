  ...
  const faqTexts = {
    ru: {
      ...
      items: [
        ...
        {
          q: "⏱️ Когда заказ считается выполненным?",
          a: "Статус становится «Выполнено» после подтверждения администратором в рабочей группе.",
        },
        {
          q: "🎟️ Как работает промокод?",
          a: "Введите промокод до оформления заказа. Если код неверный или неактивен, заявка не отправится.",
        },
        {
          q: "💳 Какие методы оплаты доступны?",
          a: "В miniapp показывается актуальный способ оплаты. Перед отправкой заказа проверьте сумму в ₽ и $.",
        },
        {
          q: "🔒 Это безопасно?",
        ...
        },
        {
          ...
          a: "Откройте «Поддержка» в разделе «О нас» и отправьте ID операции или @username для быстрой проверки.",
        },
      ],
    },
    en: {
      ...
      items: [
        ...
        {
          q: "⏱️ When is an order marked as completed?",
          a: "The status changes to “Completed” after an admin confirms it in the operations group.",
        },
        {
          q: "🎟️ How does a promo code work?",
          a: "Enter the promo code before placing an order. Invalid or inactive codes are rejected.",
        },
        {
          q: "💳 Which payment method is used?",
          a: "The current payment method is shown in miniapp. Always check both ₽ and $ totals before sending.",
        },
        {
          q: "🔒 Is it safe?",
        ...
        },
        {
          ...
          a: "Open “Support” in the “About us” section and send your operation ID or @username.",
        },
      ],
    },
  };
